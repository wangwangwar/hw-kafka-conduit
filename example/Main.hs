...
import           Data.Monoid          ((<>))
import           Kafka.Conduit.Sink   as KSink
import           Kafka.Conduit.Source as KSource
...
consumerProps = KSource.brokersList [kafkaBroker]
...
producerProps = KSink.brokersList [kafkaBroker]
